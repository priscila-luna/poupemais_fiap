...
public class Despesa {
    ...
    public Despesa(String string, double i, Calendar calendar, String string2, int j) {
    	super();
    }


    public Despesa(int idDespesa, String dsDespesa, double vlrDespesa, Calendar data, String tpDespesa, int idUsuario) {
    	super();
